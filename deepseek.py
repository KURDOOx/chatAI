...
<style>
.stApp {
    background: url('<iframe src="https://gifer.com/embed/Scpn" width=480 height=480.000 frameBorder="0" allowFullScreen></iframe><p><a href="https://gifer.com">via GIFER</a></p>') no-repeat center center fixed;
